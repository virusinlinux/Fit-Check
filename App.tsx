        ...
        {!modelImageUrl ? (
          ...
          >
            <main className="flex-grow relative flex flex-col md:flex-row overflow-hidden">
              <div className="w-full h-full flex-grow flex items-center justify-center relative p-4 md:p-8">
                <Canvas 
              ...
              <aside 
                className={`absolute md:relative md:flex-shrink-0 bottom-0 right-0 h-auto md:h-full w-full md:w-[400px] bg-white/80 md:bg-white backdrop-blur-md md:backdrop-blur-none flex flex-col border-t md:border-t-0 md:border-l border-gray-200 transition-transform duration-500 ease-in-out ${isSheetCollapsed ? 'translate-y-[calc(100%-4.5rem)]' : 'translate-y-0'} md:translate-y-0`}
              ...
              >
                  ...
                  <div className="p-4 md:p-8 pb-24 md:pb-8 overflow-y-auto flex-grow flex flex-col gap-8">
                    {error && (
